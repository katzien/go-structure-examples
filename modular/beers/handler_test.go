...
//	var cellarFromRequest []beers.Beer
//	var cellarFromStorage []beers.Beer
//
...
//	}
//
//	var mapCellar = make(map[beers.Beer]int, len(cellarFromStorage))
